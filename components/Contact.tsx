        ...
        <div className="bg-sports-surface rounded-lg overflow-hidden border border-white/5 shadow-xl">
           <div className="md:flex">
              <div className="bg-sports-navy p-12 text-white md:w-2/5 flex flex-col justify-between relative overflow-hidden">
                 {/* Subtle gradient instead of blob */}
                   ...
                   <div>
                     ...
                     <div className="space-y-6">
                       ...
                       <a 
                         ...
                         className="flex items-center text-sm hover:text-sports-lime transition-colors group"
                       >
                         <div className="w-10 h-10 rounded bg-sports-surface border border-white/5 flex items-center justify-center mr-4 group-hover:bg-sports-lime group-hover:text-sports-navy transition-all">
                   ...
                   <div className="mt-10 pt-8 border-t border-white/10">
                      ...
                      <div className="flex gap-4">
                        <a 
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-10 h-10 rounded bg-sports-surface border border-white/5 flex items-center justify-center text-sports-muted hover:bg-blue-700 hover:text-white hover:border-transparent transition-all duration-300"
                          aria-label="LinkedIn"
                        >
                        ...
                        <a 
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-10 h-10 rounded bg-sports-surface border border-white/5 flex items-center justify-center text-sports-muted hover:bg-black hover:text-white hover:border-transparent transition-all duration-300"
                        ...
                        <a 
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-10 h-10 rounded bg-sports-surface border border-white/5 flex items-center justify-center text-sports-muted hover:bg-pink-600 hover:text-white hover:border-transparent transition-all duration-300"
              ...
              <div className="p-12 md:w-3/5 bg-sports-surface">
                {submitStatus === 'success' ? (
                  <div className="h-full flex flex-col items-center justify-center text-center">
                    <div className="w-16 h-16 bg-sports-lime/20 rounded-full flex items-center justify-center mb-6 border border-sports-lime/50">
                       <svg className="w-8 h-8 text-sports-lime" fill="none" viewBox="0 0 24 24" stroke="currentColor">
